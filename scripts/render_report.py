#!/usr/bin/env python3
"""Render a Skillproof findings.json into a self-contained themed report.html.
...
<title>Skillproof report — {esc(run.get('topic',''))[:60]}</title><style>{CSS}</style></head>
<body><div class="doc"><header>
<h1><span class="metal">✦ Skillproof report</span></h1>
...
Generated by <a href="../../README.md">Skillproof</a> — dry-run, X {esc(src.get('x','off'))}.
...
<span style="color:var(--gold-hi)">✦</span> part of the -proof family — DATproof · Modelproof · Skillproof
